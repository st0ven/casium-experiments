...
*/
export const reorderListCommand = [
  ReorderList,
...
*/
export const resetListOrderCommand = [
  ResetListOrder,
  function (model) {
    return {
      ...model,
...
*/
export const toggleItemSelectionCommand = [
  ToggleItemSelection,
